    ...
    <div className="w-full bg-white p-10 flex flex-col justify-between ">
      ...
      <div className="border-b-[1px] border-b-slate-300 py-2">
        <div className=" flex items-center justify-between">
          <p className="uppercase font-medium">Cantidades</p>
          <p>{totalQty}</p>
        </div>
      </div>
      <div className="border-b-[1px] border-b-slate-300 py-2">
        <div className=" flex items-center justify-between">
          <p className="uppercase font-medium">Deposito</p>
      ...
      {isLoggedIn ? (
        <button
          ...
          className="bg-black text-slate-100 mt-4 py-3 px-6 hover:bg-yellow-700 cursor-pointer duration-500"
        >
          Haz tu deposito{' '}
        </button>
      ) : (
