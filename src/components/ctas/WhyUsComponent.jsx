  ...
  return (
    <section className="mb-11 px-20 sm:px-5 w-[100%] rounded-26xl flex flex-row flex-wrap pt-[140px] sm:pt-10 pb-0 box-border  justify-between text-left text-14xl text-gray-white font-poppins">
      <div className="w-[50%] md:min-w-[100%] flex flex-col flex-wrap items-start justify-start gap-[30px] mb-11">
        ...
        >
           <AnimatedText text={`¿Por qué`} text2={`Operarte`} text3={`con Nosotros?`} descrp={`Usamos las tecnicas mas novedosas de la cirugía plástica estética y reconstructiva para mejorar el aspecto físico, estético, funcional y emocional  de todos y cada uno de mis pacientes sin dejar el lado humano, ético y profesional. `} className="text-white text-5xl sm:text-4xl font-headerFont"/>
        </motion.div>
