...
const Details = ({ place, years, position, description }) => {
  ...
  <li ref={ref} className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between">
    ...
    className=""
    >
      <h3 className="relative tracking-[0.04em] font-medium text-transparent bg-clip-text bg-gradient-to-br from-yellow-500 mb-3 to-yellow-600 text-5xl sm:text-3xl font-headerFont">{place}&nbsp;</h3>
