      ...
      <div className="w-[95%] flex flex-row md:flex-col my-[60px]">
        ...
        <div className="w-1/2 font-headerFont md:w-full sm:w-[90%] px-5 sm:px-3 mb-20 shrink-0 flex flex-col items-start justify-start gap-[20px]">
          ...
          <motion.h2
            ...
            className="m-0 relative w-full text-2xl leading-[48px] font-semibold font-inherit"
          >
          ...
          >
            ¿Tienes dudas adicionales? mándanos un mensaje o agenda una consulta
            y aclaramos tus preguntas.
          </motion.div>
        ...
        >
          {accordions.map((item, id) => {
            ...
            return (
              <div
                key={id}
                className="text-white cursor-pointer  rounded-t-md rounded-b-none bg-transparent shadow-[0px_32px_64px_rgba(57,_20,_0,_0.04)] p-5 my-3 border-t border-yellow-600"
              >
                <Accordion
                  pregunta={pregunta}
                  respuesta={respuesta}
