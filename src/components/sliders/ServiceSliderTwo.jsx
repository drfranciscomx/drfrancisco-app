...
export const serviceData = [
  {
    backimage: <Image src={slide_image} fill alt="iamge" />,
    title: 'Cara',
    description:
      'lorem ipsum dolor sit amat connectaur antispacin alit. Dum lorem ipsum dolor sit amat connectaur antispacin alit. Dum lorem ipsum dolor sit amat connectaur antispacin alit. Dum',
  },
  {
    backimage: (
      <Image
        ...
        return (
          <SwiperSlide key={index}>
            <div className="h-[100%] inline-block align-middle px-4 py-20 lg:py-10 relative">
              <div className="relative z-10 mx-auto my-0 font-playfair-display text-5xl">
                {item.title}
              </div>
              <p className="relative z-10 text-base font-sans font-light">
                {item.description}
              </p>
              <motion.a
                whileHover={{ y: -4 }}
