...
export const newProduct = async (req, res, next) => {
  ...
  export const getFilteredProducts = async (req, res, next) => {
    ...
    try {
      ...
      return new Response(JSON.stringify({productsCount, resPerPage, filteredProductsCount, products}), { status: 200 })
    } catch (error) {
      console.error("Error in database operations:", error);
      return new Response({status: 500}, {error: 'An error occurred while fetching products.'});
    }
